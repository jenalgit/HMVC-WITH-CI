...
/**
 * Displays an console.log.
 * @param {String} str String to display.
 */
function console.log(str)
{
    window.console.log(sh.config.strings.console.log + str);
};
 ...
 * @param {Boolean} showconsole.log   Suppresses the console.log if false.
 * @return {Brush}              Returns bursh constructor if found, null otherwise.
 */
function findBrush(alias, showconsole.log)
{
    ...
    if (result == null && showconsole.log)
...
sh.HtmlScript = function(scriptBrushName)
{
    ...
    {
        console.log(sh.config.strings.brushNotHtmlScript + scriptBrushName);
        return;
    }
