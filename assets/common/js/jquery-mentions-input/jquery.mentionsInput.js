...
//$(function($, _, undefined){
//$(document).ready(function($, _, undefined){
    // Settings
...
///            var updatedMessageText = start + mention.value + ' ' + end;
	    var updatedMessageText = start + '@' + mention.username + ' ' + end;
        ...
        function doSearch(query) {
            ...
            if((query == '') || (query && query.length && query.length >= settings.minChars)) {
	    ...
	    function positionAutocomplete(elmAutocompleteList, elmInputBox) {
            ...
            if (elmAutocompleteListPosition == 'absolute') {
                ...
                elmAutocompleteList.css('width', '35em'); // Sort of a guess
