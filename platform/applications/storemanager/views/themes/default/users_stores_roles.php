<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
  ...
  .error { 
   ...
   <?php    echo css('lib/onoff/onoff.css'); echo css('lib/aciTree/aciTree.css'); echo js('lib/aciTree/aciPlugin.min.js'); echo js('lib/aciTree/aciTree.min.js');  echo js('lib/onoff/onoff.js'); ?>
            <div class="row">
                        <!-- block -->
                        <div class="col-md-12">
