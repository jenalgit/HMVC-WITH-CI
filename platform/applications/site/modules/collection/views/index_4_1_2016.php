                           ...
                           <div class="votes-css">
                            ...
                            ><i class="fa fa-caret-up" ></i><span id="number_0_<?php echo $collection['id']?>"><?php echo vote_count_by_id('0',$collection['id'])?></span></a>
                                <?php if(!empty($collection['url'])) { ?>
                                  <a href="javascript:;" class="get-button btn-color button"> Get It</a>
                                  <?php }else{ ?>
                                  <a href="javascript:;" class="get-button btn-color button"> Get It</a>
                                  <?php } ?>
                         </div>
                   ...
                   <?php } ?>
                    ...
                    <?php echo comments_data_collection($collection['id']);?>    
                     ...
                     <div class="comment-div common-new">
                       <p>
                         Commenting is limited to those invited by others in the community. <br>
    You've been added to the waitlist. <br>
    Questions? Check out our <a href="javascript:;">FAQ</a>
                   ...
                   <div class="collection-sidebar common-new">
                        <div class="collection-widget-css">
                             <div class="widget-title">SHARE</div>
                              <div class="sharing-icons-css">
                                 <a href="javascript:;" class="fb-css"><i class="fa fa-facebook"></i></a>
                                 <a href="javascript:;" class="tw-css"><i class="fa fa-twitter"></i></a>
                                 <a href="javascript:;" class="li-css"><i class="fa fa-linkedin"></i></a>
                                 <a href="javascript:;" class="pi-css"><i class="fa fa-pinterest"></i></a>
                              ...
                              <div class="list-user-info">
                                           <ul>
                                              <li class="collection-user">
                                                        <span class="common-card-css"> <img src="../assets/curatigo/images/avatar_small.jpg">
                        ...
                        <div class="collection-widget-css">
                             <div class="widget-title"><?php echo vote_count_by_id('0',$collection['id'])?> UPVOTES</div>
                              <div class="list-user-info">
                              <div id="user_carousel" class="owl-carousel">
                        ...
                        <div class="collection-widget-css no-makers">
                             ...
                             <div class="widget-title">appears in these collections</div>
                              <div class="appear-collection-css">
                                 <p class="collection-meeting">Meeting schedulers<br/>Tools to Share Calendars, Match Calendars, or take over the entire process. Scheduling is difficult and still not solved</p>
                                                ...
                                                <div class="collection-user-info-css common-card">
                                                   <div class="common-card-mid"> 
                                                    <a class="bg-new-css" href="javascript:;">
                                                     ...
                                                     <button class="button btn-color follow-btn" href="javascript:;">Follow</button> 
                                                    </a>
                                                 </div>
                                                </div>
...
<div class="full-page-slider product-view"  id="img-repo">
 ...
 <script type="text/javascript" src="<?php echo $this->config->item('link_base_url'); ?>assets/curatigo/js/isotope.js" language="javascript"></script> 
     <script type="text/javascript" src="<?php echo $this->config->item('link_base_url'); ?>assets/curatigo/js/pi.js" language="javascript"></script> 
        <script type="text/javascript" src="<?php echo $this->config->item('link_base_url'); ?>assets/curatigo/js/owl.carousel.js" language="javascript"></script> 
