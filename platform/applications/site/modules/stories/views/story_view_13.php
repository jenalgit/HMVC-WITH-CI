                      ...
                      <div class="col-lg-10 col-md-10 col-sm-8 pro-right  pro-left">
                        <div class="col-lg-10 col-md-10 col-sm-10   pro-left">
                          ...
                          <div class="story-left-bottom">
                            ...
                            <span><?php echo comment_count_html($val_left['id']);?></span>
 ...
 <div class="stories-list-content common-new" id="story-<?php echo $r;?>">
                         ...
                         <ul>
                          ...
                          <?php echo username_photo_by_id($val['user_id']);?>
                            ...
                            <div class="dropdown-menu collection-user-info-css common-card" role="menu">                             
                             ...
                             <li><a href="javascript:;" class="comments-show common-story-section" rel="#comment-target" id="<?php echo $val['id'].'_'.$val['url_slug']?>"><i class="fa fa-comment-o"></i> <?php echo (comment_count_html($val['id'])!='')? comment_count_html($val['id']):' Comment';?></a></li>
                         </ul>                      
                      </div>                      
                    </div>                    
                    ...
                    <div class="stories-content-mid common-new">
                      ...
                      <?php if (strlen($string_dt) > 201) {?>
                       <br><div class="text-center"> <a class="button see-more-story btn-color" href="javascript:;" id="<?php echo $val['id'].'_'.$val['url_slug']?>">Read More</a> </div>
                        <?php }?>
                  ...
                  <?php echo comments_data($val['id'],1,'');?>                     
                             ...
                             <div class="common-new comment-textarea">
                                <span id="comment_msg_<?php echo $val['id']?>"></span>
                                   <textarea class="form-control from-comment mention" placeholder="Add a comment....." id="commentsubmit_<?php echo $val['id']?>" ></textarea> <a href="javascript:;" class="enter-text"><i class="fa fa-level-down"></i></a>
                              
                            </div>

                               <?php if(comment_count($val['id'])>0){?>  
                      <div class="load-more common-new"> <a href="javascript:;" rel="#comment-target" class="common-story-section" id="<?php echo $val['id'].'_'.$val['url_slug']?>"><i class="fa  fa-arrow-up"></i> View all <?php echo comment_count_html($val['id']);?></a> </div>
                   <?php }?>
                   ...
                   <div class="create-story-mid common-new">                   
                    ...
                    <div class="create-story-field common-new story-button-css">
                      <div class="col-lg-4 col-sm-4 col-md-4">
                        ...
                        <input type="reset" class="button btn-color btn-green" id="story_reset" value="Reset">                      
                    </div>    
               </div>              
                </div>
           </div>
