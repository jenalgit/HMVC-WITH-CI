...
<script>   
               ...
               success: function(response)
             {
                 alert('store is succesfully updated');
                   if(response > 0)
                   {
                       ...
                       document.getElementById('stores_id').value = store_id;
 ...
 $('#upload_pan').on('change', function (e)
  ...
  { 
        ...
        <div class="col-md-12">
          <div class="portlet box blue" id="form_wizard_1">
            <div class="portlet-title">
              <div class="caption">
                <i class="fa fa-gift"></i> Update Store - 
          ...
          <form  name="store_description"  id="store_description"  class="form-horizontal" enctype="multipart/form-data" method="POST">
                        ...
                        <textarea class="form-control" name="description" id="description"><?php echo $stores->store_description; ?></textarea> 
                                                     ...
                                                     <label class="control-label col-md-3">Store Admin<span class="required">* </span></label>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                            <textarea class="form-control" id="address" name="address" required><?php echo $stores->address; ?></textarea>  
            ...
            <textarea class="form-control" name="p_address" id="p_address"><?php echo $stores->pickup_address; ?></textarea>
                                                         ...
                                                         <div class="form-group">
                                                           ...
                                                           <div class="col-md-6">
                                                              <select class="form-control" name="country_p" id="p_country" required> 
                                                              <option value="<?php echo $stores->country; ?>">---Select---</option>
                                                                    <option value="IND">India</option>
                                                                </select>
                                                            </div>
                                                      ...
                                                      <div class="form-group">
                                                           <label class="control-label col-md-3">Pickup State
                                                            ...
                                                            <div class="col-md-6">
                                                         <select class="form-control" name="pickup_state" id="p_state" required>
                                                        ...
                                                        <div class="form-group">
                                                           ...
                                                           <div class="col-md-6">
                                                                <select class="form-control" name="pickup_city" id="p_city" required>
      ...
      <form  name="store_description_business"  id="store_description_business"  class="form-horizontal" enctype="multipart/form-data" method="POST">                                              <?php foreach ($single_stores_business as $stores): ?>          
                                                            <div class="row">
