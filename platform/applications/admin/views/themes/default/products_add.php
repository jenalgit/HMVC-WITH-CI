                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                    	<div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption">
                                	<span class="caption-subject font-blue-madison bold uppercase">Add a product</span>
                                </div>                                        
                            </div>
                         ...
                         <label class="control-label">Page title (maxlength - 62 char) <span class="required">
                                  * </span></label>
                                  ...
                                  <option value="2" >Manual</option> 
                                   ...
                                   <br/>   
          <input type="text"  class="form-control"  maxlength="62"   name="page_title"  id="page_title_value_p"    readonly>
         <br/>  
                            	...
                            	<div class="onlineStore">                                                	
                                   ...
                                   <input  type="checkbox" class="check_onlineStore"   name="featured" id="featured"  style="margin-top: 3px;">
                                     <label class="control-label">Featured </label>
                                           <br/>
               <input  type="checkbox" class="check_onlineStore"  name="product_active" id="product_active"  style="margin-top: 3px;">
                                   <label class="control-label"> Active </label>
                                  <br/> 
                             <label class="control-label">Publish date <span class="required">
                                  * </span></label>
                             <br/>        
                <input type="text"  id="datetimepicker1"  name="publish_date"   required>
                         ...
                         <li><a href="<?php echo base_url();?>products"><button type="button" class="btn btn-default default_btn">Cancel</button></a></li>
                                                <li><button type="submit" class="btn btn-success"  id="save_product" >Save Product</button></li>
                                            </ul>
                                        </div>  
                                        </form> 
                                           </div>
...
<script src="../assets/curatigo-admin/js/product_add_main.js" type="text/javascript"></script>
