                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                    	<div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption">
                                	<span class="caption-subject font-blue-madison bold uppercase">Add a Story</span>
                                </div>                                        
                            </div>
                         ...
                         <label class="control-label">Page title (maxlength - 62 char) <span class="required">
                                  * </span></label>
                                  ...
                                  <option value="2" >Manual</option> 
                                   ...
                                   <br/>  
          <input type="text" readonly  class="form-control"  maxlength="60"  name="page_title"  id="page_title"   required>
         <br/>  
            <input type="text"   class="form-control"  maxlength="60"  name="manual"  id="page_title_value" style="display:none;">
                    </div>
                    <div class="form-group">
     ...
     <textarea style="width: 390px;height: 80px; border:1px solid #e5e5e5; background:#fff;" name="tag_product"  id="tag_product" class="tag-text" rows="1"></textarea>      
                       ...
                       <div class="add_productForm online_productStore">
                            	<div class="onlineStore">                                                	
                                    <h2 class="addImages">Story Visibility</h2>
                                    <div class="inner">
                        <input  type="checkbox" class="check_onlineStore"   name="featured" id="featured" value="1" style="margin-top: 3px;">
                                     <label class="control-label">Featured </label>
                                           <br/>
               <input  type="checkbox" class="check_onlineStore"  name="product_active" id="product_active" value="1" style="margin-top: 3px;">
                                   <label class="control-label"> Active </label>
                                   <br/>
                             <label class="control-label">Publish Date<span class="required">
                                  * </span></label> 
                                  <br/>     
                <input type="text"  id="datetimepicker"  name="publish_date"   placeholder="Date and Time"  class="form-control ">
                         ...
                         <li><a href="<?php echo base_url();?>stories"><button type="button" class="btn btn-default default_btn">Cancel</button></a></li>
                                                <li><button type="submit" class="btn btn-success"  id="save_story" >Save Story</button></li>
                                            </ul>
                                        </div>  
                                        </form> 
                                           </div>
...
<script src="../assets/curatigo-admin/js/story_add.js" type="text/javascript"></script>  
...
<!--javascript for add product start  --> story_add_validation.js 
