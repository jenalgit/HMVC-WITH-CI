<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
  ...
  .error { 
    ...
    font-size: 18px;
      ...
      <h3 class="page-title" style="color: #578ebe !important; font-size:16px; font-weight:bold">
     Add Categories 
      </h3>
          ...
          <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
              <li>
                <a href="<?php echo base_url();?>category/index">View Category</a>
              </li>
            </ul>
          </div>
        </div>
                               ...
                               <div class="portlet-body form">
                                 <form action="<?php echo base_url();?>category/add" id="form_sample_3" method="post" class="form-horizontal">
                                <div class="form-body">
