...
class Current_user extends CI_Model {
    ...
    public function register($username, $password,$firstName,$lastName,$gender,$dateOfBirth){
        ...
        echo "<hr>username-".$username;
         echo "<hr>-password".$password;
         echo "<hr>-firstName".$firstName;
         echo "<hr>-lastName".$lastName;
         echo "<hr>-gender".$gender;
         echo "<hr>-dateOfBirth".$dateOfBirth;
        exit;
    }
    ...
    public function login_by_id($id) {
        ...
        if (is_callable($this->user_autorization_check)) {
            ...
            $authorized = is_array($this->user_autorization_check)? $this->user_autorization_check[0]->{$this->user_autorization_check[1]}($user)
