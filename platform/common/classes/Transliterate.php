...
class Transliterate {
    ...
    // A correction by Deepak Patil <deepak.patil@relesol.com>, 23-APR-2014: 'Ч' -> 'Ch', 'ч' -> 'ch'
    ...
    public static function cyr_to_lat($string, $language = null) {
        ...
        switch ($language) {
            ...
            default:
                ...
                // Added by Deepak Patil <deepak.patil@relesol.com>, 23-APR-2014.
    ...
    public static function to_ascii($string, $language = null) {
        ...
        if (IS_CODEIGNITER) {
            ...
            if (!isset($search) || !is_array($search)) {
                ...
                // Added by Deepak Patil <deepak.patil@relesol.com>, 03-OCT-2013.
