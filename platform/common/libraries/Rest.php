...
class REST
{
    ...
    function __construct($config = array())
    {
        ...
        */
        $this->_ci->load->library('curl');  // Enabled by Deepak Patil <deepak.patil@relesol.com>, 14-FEB-2012.

        // Load the cURL spark which this is dependant on
        //$this->_ci->load->spark('curl/1.2.1'); // Disabled by Deepak Patil <deepak.patil@relesol.com>, 15-FEB-2012.
