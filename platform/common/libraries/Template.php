...
class Template
{
    ...
    // Removed by Deepak Patil <deepak.patil@relesol.com>, 27-DEC-2013.
    //private $_parser_enabled = true;
    //private $_parser_body_enabled = true;
    //

    // Added by Deepak Patil <deepak.patil@relesol.com>, 27-DEC-2013.
    ...
    {
        // Added by Deepak Patil <deepak.patil@relesol.com>, 25-OCT-2012.
        ...
        foreach ($this->_partials as $name => $partial)
        {
            ...
            {
                // Modified by Deepak Patil <deepak.patil@relesol.com>, 28-DEC-2013.
        ...
        if ($this->_layout)
        {
            ...
            // Modified by Deepak Patil <deepak.patil@relesol.com>, 25-JUN-2014.
            // A very dirty fix for file://10.1.0.5/Web Applications/Products/curatigo/trunkissues/16
            //// Modified by Deepak Patil <deepak.patil@relesol.com>, 27-DEC-2013.
        ...
        if ( ! $return)
        {
            ...
            // Added by Deepak Patil <deepak.patil@relesol.com>, 29-MAR-2013.
            return;
            //
        }
    ...
    // Added by Deepak Patil <deepak.patil@relesol.com>, 09-NOV-2013.
    ...
    public function set_metadata($name, $content, $type = 'meta')
    {
        ...
        // Added by Deepak Patil <deepak.patil@relesol.com>, 29-JAN-2012.
    ...
    //--------------------------------------------------------------------------
    // Added by Deepak Patil <deepak.patil@relesol.com>, 23-OCT-2013.
    ...
    // End of "Added by Deepak Patil <deepak.patil@relesol.com>, 23-OCT-2013."
    //--------------------------------------------------------------------------
}
