 ...
 * Version: 1.1.12
 * @author Deepak Patil <deepak.patil@relesol.com>, 2015, 2012-2015.
...
class Email extends CI_Email {
    ...
    public function subject($subject) {
        ...
        if ($this->mailer_engine == 'phpmailer') {
            ...
            // Modified by Deepak Patil <deepak.patil@relesol.com>, 01-AUG-2015.
    ...
    // Modified by Deepak Patil <deepak.patil@relesol.com>, 16-JAN-2014.
        ...
        if ($this->mailer_engine == 'phpmailer') {
            ...
            if ($mime == '') {
                ...
                if (strpos($file, '://') === FALSE && ! file_exists($file)) {
                    ...
                    // Modified by Deepak Patil <deepak.patil@relesol.com>, 14-JAN-2014.
                    //return FALSE;
                    return $this;
                    //
                }
    ...
    // Added by Deepak Patil <deepak.patil@relesol.com>, 16-JAN-2014.
...
'.$message.'
    ...
    protected function _plain_text($html) {
        ...
        if (!function_exists('html_to_text')) {
            ...
            $body = @ html_entity_decode($html, ENT_QUOTES, $this->charset); // Added by Deepak Patil <deepak.patil@relesol.com>, 28-JUL-2013.
