...
echo css('../assets/js/lib/jquery_ui/jquery-ui.theme.min.css');
echo css('../assets/js/lib/jquery_ui/jquery-ui.min.css');
echo css('lib/common/common.min.css');
echo css('auth_login.css');
...
echo js('lib/jquery_ui/jquery-ui.min.js');
