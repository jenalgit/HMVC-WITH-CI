...
/*$config['base_path'] = 'C:\\xampp\\htdocs\\curatigo\\';


$config['link_base_url'] = 'http://localhost/curatigo/';*/


/*$config['base_path'] = '/home/curatigo/sub_domain/test/';
$config['link_base_url'] = 'http://test.curatigo.com/';*/
...
=======
$config['base_path'] = '/home/curatigo/sub_domain/test/';
>>>>>>> b6d4c5969207f12e51adc828e6d124a10ccaf2d4
$config['link_base_url'] = 'http://test.curatigo.com/';
*/

$config['base_path'] = '/var/www/html/curatigo/';
$config['link_base_url'] = 'http://10.1.1.27/curatigo/';
...
$config['auth_url'] = '/auth/';
$config['default_theme'] = 'default';
$config['current_theme'] = $config['default_theme'];
$config['current_theme_path'] = 'themes/'.$config['default_theme'].'/';
...
//$config['cookie_path']      = $DETECT_URL['base_uri']; // active if you want seprate authentication for each modules/application
$config['cookie_path']      = "/"; //change to make common login for all the modules
