...
|--------------------------------------------------------------------------
*/
$config['site_name'] = 'curatigo';
$config['contact_organization'] = 'Reliable E Solutions';
$config['contact_address'] = 'South city - I, Gurgoan, Haryana';
$config['contact_phone'] = '00 000 0000000000';
$config['contact_fax'] = '';
$config['contact_email'] = 'deepak.patil@relesol.com';
$config['contact_first_name'] = 'Deepak';     // Contact person, first name.
$config['contact_last_name'] = 'Patil';      // Contact person, last name.
...
|--------------------------------------------------------------------------
*/
$config['copyright_note'] = 'Copyright &copy; {year} Reliable E Solutions.';
...
$config['site_email'] = 'deepak.patil@relesol.com';
