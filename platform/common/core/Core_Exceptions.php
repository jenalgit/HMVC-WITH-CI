...
class Core_Exceptions extends CI_Exceptions {
    ...
    public function show_404($page = '', $log_error = TRUE) {
        ...
        if ($log_error) {
            // Removed by Deepak Patil <deepak.patil@relesol.com>, 12-OCT-2013.
    ...
    public function show_error($heading, $message, $template = 'error_general', $status_code = 500)
    {
        ...
        ob_start();
        // Modified by Deepak Patil <deepak.patil@relesol.com>, 14-APR-2014.
    ...
    public function show_exception(Exception $exception)
    {
        ...
        // Added by Deepak Patil <deepak.patil@relesol.com>, 30-OCT-2014.
