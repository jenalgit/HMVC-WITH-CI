...
if ( ! function_exists('get_config'))
{
    ...
    function &get_config(Array $replace = array())
    {
        ...
        // Added by Deepak Patil <deepak.patil@relesol.com>, 13-OCT-2013.
        global $DETECT_URL;
        //

        if (empty($config))
        {
            // Added by Deepak Patil <deepak.patil@relesol.com>, 02-OCT-2013.
            ...
            // Removed by Deepak Patil <deepak.patil@relesol.com>, 02-OCT-2013.
            //$found = FALSE;
            //
            if (file_exists($file_path))
            {
...
if ( ! function_exists('load_class'))
{
    ...
    function &load_class($class, $directory = 'libraries', $param = NULL)
    {
        ...
        // Added by Deepak Patil <deepak.patil@relesol.com>, 11-OCT-2013.
...
if ( ! function_exists('html_escape'))
{
    ...
    function html_escape($var, $double_encode = TRUE)
    {
        ...
        // Added by Deepak Patil <deepak.patil@relesol.com>, 25-AUG-2014.
