...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	//public $scope = "email, user_about_me, user_birthday, user_hometown, user_website, read_stream, offline_access, publish_stream, read_friendlists, public_profile, user_friends";

	//public $scope = "email, public_profile, user_about_me, user_birthday, user_hometown, user_website, public_profile, user_friends";
	...
	*/
	function getUserProfile()
	{
		...
		try{ 
			$data = $this->api->api('/me?fields=id,name,first_name,last_name,email,link,gender,website,locale,picture,hometown,birthday'); 
	...
	*/
	...
	{
		try{ 
			$response = $this->api->api('/me/taggable_friends?fields=id,name,picture&limit=200'); 
		}
		catch( FacebookApiException $e ){
