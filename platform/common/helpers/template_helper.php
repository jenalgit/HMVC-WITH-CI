 ...
 * @author Deepak Patil <deepak.patil@relesol.com>, 2015, 2012-2013
 * @license The MIT License, http://opensource.org/licenses/MIT
 * Some original functions from Phil Sturgeon have been taken as a starting point.
 */

// Added by Deepak Patil <deepak.patil@relesol.com>, 29-DEC-2013.
...
if (!function_exists('template_enable_oldie')) {
     ...
     * @autor Deepak Patil <deepak.patil@relesol.com>, 2013.
     * @license The MIT License, http://opensource.org/licenses/MIT
     * @return boolean
     */
...
if (!function_exists('template_ie')) {
    ...
    // Added by Deepak Patil <deepak.patil@relesol.com>, 25-OCT-2013.
...
if (!function_exists('template_ie_mobile')) {
    ...
    // Added by Deepak Patil <deepak.patil@relesol.com>, 24-OCT-2013.
...
if (!function_exists('html_tag')) {
    ...
    // Added by Deepak Patil <deepak.patil@relesol.com>. 21-OCT-2013.
...
if (!function_exists('base_href')) {
    ...
    // Added by Deepak Patil <deepak.patil@relesol.com>. 26-OCT-2013.
    function base_href() {
...
if (!function_exists('favicon')) {
    ...
    // Added by Deepak Patil <deepak.patil@relesol.com>. 27-OCT-2013.
...
if (!function_exists('js_platform')) {
    ...
    // Added by Deepak Patil <deepak.patil@relesol.com>. 22-OCT-2013.
