...
if (!function_exists('to_https')) {
    ...
    // Added by Deepak Patil <deepak.patil@relesol.com>, 08-JUN-2014.
...
if ( ! function_exists('auto_link'))
{
     ...
     * @author Deepak Patil <deepak.patil@relesol.com> (adaptation)
     *
     * @see url_helper
    ...
    function auto_link($str, $type = 'both', $attributes = '')
    {
        ...
        // Modified by Deepak Patil <deepak.patil@relesol.com>, 19-DEC-2013.
...
if (!function_exists('url_title') && IS_UTF8_CHARSET) {
    ...
    // Added by Deepak Patil <deepak.patil@relesol.com>, 31-DEC-2013.
